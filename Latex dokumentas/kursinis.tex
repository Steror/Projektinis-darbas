...
Šio \textbf{darbo tikslas} yra apibrėžti reikalavimus, suprojektuoti galutinę sistemą, pasirinkti technologijas tinkančias sistemos kūrimui ir sukurti sistemos prototipą. 
...
Kursiniame darbe buvo įvertintas esamo tinklapio panaudojamumas pagal David Travis gaires ir Jakob Nielsen euristikas\cite{Kursinis}. Prie defektų parašyti skaičiai nurodo kuris maketas ir kuri maketo dalis juos taiso.
...
\begin{tabular}{ |p{13cm}|p{2,5cm}| } 
 \hline
	...
	3) Paieškos rezultatai yra aiškūs, naudingi ir reitinguojami pagal atitikimą užklausai & ne (\ref{img:PaieškosPrototipas}.2 pav.) \\ \hline
	...
	5) Jei negražinamas nei vienas rezultatas, sistema pasiūlo idėjų ar nustatymų pagerinti užklausai atsižvelgiant į atpažįstamas įvesties problemas & ne (\ref{img:PaieškosPrototipas}.4 pav.) \\ \hline
	6) Paieška dailiai susitvarko su tuščia užklausa & tenkina \\ \hline
	7) Dažniausios užklausos gražina naudingus rezultatus & ne (\ref{img:PaieškosPrototipas}.2 pav.) \\ \hline
	8) Paieškos sistema turi šabloną arba patarimus kaip ją deramai naudoti & ne (\ref{img:PaieškosPrototipas}.4 pav.) \\ \hline
	...
	11) Paieškos laukas pakankamai ilgas dažniausių užklausų ilgiams & ne (\ref{img:PaieškosPrototipas}.1 pav.) \\ \hline
	...
	20) Paieškos sistema leidžia ieškoti panašių rezultatų („daugiau tokių“) & ne (\ref{img:PaieškosPrototipas}.5 pav.) \\ \hline
\end{tabular}
...
\begin{longtable}{ |p{13cm}|p{2,5cm}| } 
 \hline
	Gairė & Ar tenkina? \\ \hline
	...
	4) Navigacijos sistema plati ir sekli (daug meniu elementų), o ne gili (daug meniu lygių)  & ne (\ref{img:NavigacijosPrototipas}.4, \ref{img:NavigacijosPrototipas}.6 pav.) \\ \hline
	...
	17) Matomi pasikeitimai, kai naudotojas užveda kursorių ant kažko paspaudžiamo (neįskaitant kursoriaus pasikeitimų) & ne (\ref{img:NavigacijosPrototipas}.4, \ref{img:NavigacijosPrototipas}.6 pav.) \\ \hline
...
\section{Reikalavimai informacijos architektūrai}
Siekiant ištaisyti defektus informacijos architektūroje reikia turėti reikalavimus naujai sistemai, kurie išspręstų defektų priežastis. Tuo tikslu surašyti nefunkciniai reikalavimai paieškos sistemai ir navigacijos ir informacijos architektūrai. Reikalavimai remiasi gairėmis ir euristikomis, kurios buvo naudotos defektams surasti (lentelės \ref{PaieškosLentelėPrad}, \ref{NavigacijosirIALentelėPrad} ir \ref{EuristikųLentelėPrad}).
...
\begin{enumerate}
	...
	\item Paieškos laukas turi būti naudotojams įprastoje vietoje, dažniausiai viršuje dešinėje
...
\subsection{Papildomi nefunkciniai reikalavimai}
\begin{enumerate}
